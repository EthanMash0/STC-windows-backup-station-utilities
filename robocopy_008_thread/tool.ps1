Write-Host ""
Write-Host "Robocopy 008 Thread"
Write-Host "-------------------"
...
$log = "C:\Temp\backup_bench_logs\robocopy_008_thread\robocopy.log"
$timeLog = "C:\Temp\backup_bench_logs\robocopy_008_thread\robocopy-time.txt"
