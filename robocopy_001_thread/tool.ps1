Write-Host ""
Write-Host "Robocopy 001 Thread"
Write-Host "-------------------"
...
$log = "C:\Temp\backup_bench_logs\robocopy_001_thread\robocopy.log"
$timeLog = "C:\Temp\backup_bench_logs\robocopy_001_thread\robocopy-time.txt"
