Write-Host ""
Write-Host "Robocopy 064 Thread"
Write-Host "-------------------"
...
$log = "C:\Temp\backup_bench_logs\robocopy_064_thread\robocopy.log"
$timeLog = "C:\Temp\backup_bench_logs\robocopy_064_thread\robocopy-time.txt"
