Write-Host ""
Write-Host "Robocopy 032 Thread"
Write-Host "-------------------"
...
$log = "C:\Temp\backup_bench_logs\robocopy_032_thread\robocopy.log"
$timeLog = "C:\Temp\backup_bench_logs\robocopy_032_thread\robocopy-time.txt"
