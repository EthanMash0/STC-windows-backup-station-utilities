...
Write-Host "  Z:\benchmark\dism_compress_fast\STC.wim"
Write-Host ""
...
$log = "C:\Temp\backup_bench_logs\dism_compress_fast\dism-wim.log"
$timeLog = "C:\Temp\backup_bench_logs\dism_compress_fast\dism-wim-time.txt"
