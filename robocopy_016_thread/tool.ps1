Write-Host ""
Write-Host "Robocopy 016 Thread"
Write-Host "-------------------"
...
$log = "C:\Temp\backup_bench_logs\robocopy_016_thread\robocopy.log"
$timeLog = "C:\Temp\backup_bench_logs\robocopy_016_thread\robocopy-time.txt"
